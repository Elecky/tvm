...
def verify_max_pool2d_grad(x_shape, pool_size, strides, padding, ceil_mode):
    ...
    for target, ctx in ctx_list():
        ...
        print('op  grad is ')
        print(op_grad.asnumpy())

        np.testing.assert_allclose(op_grad.asnumpy(), ref_grad, rtol=0.01)


def test_max_pool2d_grad():
    verify_max_pool2d_grad((1, 4, 4, 4), pool_size=(2, 2), strides=(2, 2), padding=(0, 0), ceil_mode=False)
    verify_max_pool2d_grad((1, 4, 4, 4), pool_size=(1, 1), strides=(1, 1), padding=(1, 1), ceil_mode=False)
...
def test_avg_pool2d_grad():
    verify_avg_pool2d_grad((1, 4, 4, 4), pool_size=(2, 2), strides=(2, 2), padding=(0, 0),
                           ceil_mode=False, count_include_pad=True)
    verify_avg_pool2d_grad((1, 4, 4, 4), pool_size=(1, 1), strides=(1, 1), padding=(1, 1),
...
def test_conv2d_grad():
    ...
    verify_conv2d_grad((1, 128, 112, 112), (128, 128, 3, 3), [1, 1], [1, 1], [1, 1])
